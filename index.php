...
if(isset($_POST) && !empty($_POST['login']) && !empty($_POST['pass'])){
    extract($_POST);
    mysql_connect("neris_extranet.mysql.db","neris_extranet","fc2YUH9xMku9");
    mysql_select_db("neris_extranet");
    $sql = "SELECT collaborateurs.id, collaborateurs.admin, collaborateurs.nom_usage, profils.nds, profils.tdbhour, profils.tdbtask, profils.client, profils.contrat, profils.collaborateur, profils.affectation, profils.gprofil
        FROM profils INNER JOIN collaborateurs ON profils.id = collaborateurs.id_profils
        WHERE (((collaborateurs.login)='".$login."') AND ((collaborateurs.password)='".$pass."'))";
...
//    $sql = " SELECT id, admin, nom_usage FROM collaborateurs WHERE login='$login' AND password= '$pass'";
    ...
    $_SESSION['auth']=array(
        ...
        'pass' => $pass,
        'myid' => $tableau['id'],
        'myadmin' => $tableau['admin'],
        'nom_usage' => $tableau['nom_usage'],
        'nds' => $tableau['nds'],
        'tdbhour' => $tableau['tdbhour'],
        'tdbtask' => $tableau['tdbtask'],
        'client' => $tableau['client'],
        'contrat' => $tableau['contrat'],
        'collaborateur' => $tableau['collaborateur'],
        'affectation' => $tableau['affectation'],
        'gest_profils' => $tableau['gprofil']
      );
          ...
          <ul class="sidebar-menu hide">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="pages/layout/top-nav.html"><i class="fa fa-circle-o"></i> Mes notes de synthèse</a></li>
                <li><a href="pages/layout/boxed.html"><i class="fa fa-circle-o"></i> Mon planning</a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="pages/charts/chartjs.html"><i class="fa fa-circle-o"></i> Gestion des clients</a></li>
                <li><a href="pages/charts/morris.html"><i class="fa fa-circle-o"></i> Gestion des contrats</a></li>
                <li><a href="pages/charts/flot.html"><i class="fa fa-circle-o"></i> Gestion des collaborateurs</a></li>
