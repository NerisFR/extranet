                ...
                <div class="row">
                    <table align="center">
                        <tr>
                            ...
                            <td width="100"><select name="contrat_affect" id="contrat_affect">
                                <?php
                                global $list_cont;
                                echo "<option selected value='0'></option>";
...
<div class="modal fade" id="alert_affect" tabindex="-1" role="dialog">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p id="text_suppr_affect">One fine body&hellip;</p>
            <span style='opacity:0'><input id="id_affect_suppr"></input></span>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-outline pull-left" data-dismiss="modal" id="bt_alert_annul_affect">Annuler</button>
            <button type="button" class="btn btn-outline" id="bt_alert_suppr_affect">Suppr.</button>
          </div>
        </div> 
      </div>
    </div>  
...
<div class="modal fade" id="success_affect" tabindex="-1" role="dialog">
    <div class="modal-success">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p id="text_success_affect">One fine body&hellip;</p>
            
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-outline pull-right" data-dismiss="modal" id="bt_success_affect">Ok</button>
...
<script type="text/javascript" src="./forms/admin/affect/ctrl_gest_affect.js"></script>
